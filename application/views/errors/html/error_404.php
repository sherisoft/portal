...
<head>
    ...
    <title>G-AJIRI - 404 ERROR</title>

    <link href='http://fonts.googleapis.com/css?family=Roboto:300,400,500' rel='stylesheet' type='text/css'>

    <!-- uikit -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>static/assets/uikit/css/uikit.almost-flat.min.css"/>

    <!-- altair admin error page -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>static/css/error_page.min.css" />
    ...
    <div class="error_page_content">
        <div class="uk-width-8-10 uk-container-center">
            ...
            <p class="uk-text-large">
                The requested <span class="uk-text-muted">/URL</span> was not found on this server.
            </p>
