...
<!--                         <div class="md-card-toolbar">
                                ...
                                <div class="uk-width-large-1-2">
                                    <div class="uk-grid uk-grid-small">
                                        <div class="uk-width-large-1-3">
                                            <span class="uk-text-muted uk-text-small">Names (s)</span>
                                        </div>
                                    ...
                                    <div class="uk-grid uk-grid-small">
                                        <div class="uk-width-large-1-3">
                                            <span class="uk-text-muted uk-text-small">National ID</span>
                                        </div>
                                        <div class="uk-width-large-2-3">
                                            <span class="uk-text-large uk-text-middle"><?php echo $data->idNumber; ?></span>
                                        </div>
                                    </div>
                                    <hr class="uk-grid-divider">
                                    <div class="uk-grid uk-grid-small">
                                        ...
                                        <div class="uk-width-large-2-3">
                                            <span class="uk-text-large uk-text-middle"><?php echo $data->gender; ?></span>
                                        </div>
                                    </div>
    ...
    <div class="md-fab-wrapper">
        <form method="post" action="employee_update">
            <input type="text" name="id" value="<?php echo $data->userId; ?>" hidden>
