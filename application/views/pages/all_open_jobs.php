<title>G-AjirI :: Jobs</title>
    <div id="page_content">
        <div id="page_content_inner">
            <h4 class="heading_a uk-margin-bottom">All Open Jobs</h4>
                                        ...
                                        <?php
                                                ...
                                                echo '
                                                    <form method="post" action="update_job_status">
                                                        ...
                                                        <input type="text" name="sender" value="open" hidden>
                                        ...
                                        <?php
                                                ...
                                                echo '
                                                    <form method="post" action="update_job_status">
                                                        ...
                                                        <input type="text" name="sender" value="open" hidden>
                                                        <button type="submit" class="md-btn md-btn-danger md-btn-wave-light">Suspend</button>
                                                    </form>
                                                ';
